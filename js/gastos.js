...
class UI {
    ...
    agregarGastoALista(gasto) {
        ...
        item.innerHTML = ` ${gasto.nombre} <span style="color: black; font-weight: bold; class="badge badge-primary badge-pill">$${gasto.valor}</span>
            <button class="btn btn-danger btn-sm borrar-gasto">Eliminar</button>
        `;
...
function pedirPresupuesto() {
    const cantidad = prompt('indique su  presupuesto');
